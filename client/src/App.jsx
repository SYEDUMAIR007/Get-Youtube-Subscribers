...
const App = () => {
  ...
  return (
    ...
    <div>
      ...
      <a href="https://get-youtube-subscribers-dbxi.onrender.com/subscribers" className="button" target="_blank">Click me!</a>
      <p>To access the list of subscribers name and channel</p>
      <a href="https://get-youtube-subscribers-dbxi.onrender.com/subscribers/names" className="button" target="_blank">Click me!</a>
      ...
      <a href={`https://get-youtube-subscribers-dbxi.onrender.com/subscribers/${id}`} className="button" target="_blank" onClick={setTimeout(()=>searchComplete&& setid(''), 2000)}>Click me!</a>
    </div>
  )
}
